  ...
  if (typeof Component.getDerivedStateFromProps === 'function') {
    ...
    if (typeof Component.prototype.componentWillMount === 'function') {
      ...
      throw new Error(
        ...
        'Cannot polyfill getDerivedStateFromProps() for components that define componentWillReceiveP
  ...
  if (typeof Component.prototype.getSnapshotBeforeUpdate === 'function') {
    ...
    if (typeof Component.prototype.componentDidUpdate !== 'function') {
      ...
      throw new Error(
        ...
        'Cannot polyfill getSnapshotBeforeUpdate() for components that do not define componentDidUpd

ate() on the prototype'
